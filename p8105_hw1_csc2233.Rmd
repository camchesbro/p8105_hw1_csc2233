...
This data set describes a collection of penguins. Its variables include the species, habitat, body measurements, sex, and year of collection. The data set consists of `columns` columns and `rows` rows. The mean flipper length of the penguins is `avg_flipper_length` millimeters.
